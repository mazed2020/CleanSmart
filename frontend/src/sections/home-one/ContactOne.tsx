...
const CONTACT_INFO: ContactInfo[] = [
  {
    ...
    icon: "icon-envelope",
    label: "Send Email",
    title: "cleansmartcrew@gmail.com",
    link: "mailto:cleansmartcrew@gmail.com", // ✅ fixed (design same)
    linkType: "email",
  },
  {
    id: "phone",
...
const SERVICE_OPTIONS: ServiceOption[] = [
  ...
  { value: "1", label: " Residential Cleaning." },
  { value: "2", label: " Commercial Cleaning." },
  { value: "3", label: "Specialized Cleaning." },
...
const ContactOne: React.FC = () => {
  ...
  // ✅ Updated submit using toast + real backend call (design unchanged)
  const handleSubmit = useCallback(
    async (e: FormEvent<HTMLFormElement>) => {
      ...
      const selectedSubject =
        SERVICE_OPTIONS.find((opt) => opt.value === formData.subject)?.label || formData.subject;

      const payload = {
        EmailTo: "cleansmartcrew@gmail.com",
        EmailSubject: selectedSubject,
        EmailText: `Name: ${formData.name}
  ...
  return (
    <section className="contact-one">
      ...
      <div className="contact-one__shape-2 zoom-fade">
        <Image src={contImg1} alt="Decorative shape" width={200} height={200} />
      </div>
      <div className="contact-one__shape-3 zoom-fade">
        <Image src={contImg2} alt="Decorative shape" width={200} height={200} />
      </div>
...
const ImageSection: FC = () => (
  <div className="contact-one__left wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
    <div className="contact-one__img-box">
      ...
      <div className="contact-one__small-img-1 wow zoomIn animated" data-wow-delay="500ms" data-wow-duration="2500ms">
        <Image src={contImg4} alt="Service preview" />
      </div>
      <div className="contact-one__small-img-2 wow zoomIn animated" data-wow-delay="700ms" data-wow-duration="2500ms">
        <Image src={contImg5} alt="Service preview" />
      </div>
    </div>
  </div>
);
...
const SectionTitle: FC = () => (
  <div className="section-title text-left sec-title-animation animation-style2">
    <div className="section-title__tagline-box">
      ...
      <span className="section-title__tagline" style={{fontSize:"33px"}}> Ready for a Cleaner, Smarter Space?</span>
    </div>
...
const ContactForm: FC<ContactFormProps> = ({ formData, isSubmitting, onInputChange, onSubmit }) => (
